...
const { ValidateIsAdmin, ValidateIsNormalUser, CheckUserForUserDetails,
    CheckUserForUserAccount, IsLoggedIn, FetchUserWithPassword, UploadProfilePicMiddleware } = require("../../middlewares/userSanitizer");

// setting up the controllers...
const { DeleteUser, UserActivation, GetUserDetails, UpdateUser, PermanentDeleteUser, ChangeUserPassword, UploadProfilePic } = require("../../controllers/user");
...
router.post("/uploadProfile", UploadProfilePicMiddleware, UploadProfilePic);
